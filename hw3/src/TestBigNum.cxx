...
void tester(){
    ...
    if (testNo == 0){
        ...
        {
            grade << "test 1 failed.\n";
            cout << test1.printBigNum() << "\n";
        }
    }
    if (testNo == 1){
        //cout << "INT CONSTRUCTOR TESTS" << endl;
        BigNum test2 = 243;
        test2.printer(); //debugging
        if (strcmp(test2.printBigNum(), "243") == 0){
            cerr << "test 2 passed.\n";
            grade << "test 2 passed.\n";
        }else{
            grade << "test 2 failed.\n";
            cout << test2.printBigNum() << "\n";
        }
    }
    if (testNo == 2){
        BigNum test3 = -243;
        test3.printer(); //debugging
...
int main()
{
    ...
    BigNum operatortest1 = 243;
    BigNum operatortest2 = 345;
    BigNum operatortest3 = operatortest1;
    
    cout << "\n" << endl;
    
    if (operatortest1 < operatortest2)
    {
	...
	if ((operatortest1 <= operatortest2) && (operatortest1 <= operatortest3))
	{
		cout << "less than or equal to test passed" << endl;
	}
	else
	{
		cout << "less than or equal to test failed" << endl;
	}
	...
	if (operatortest1 != operatortest2)
	{
		cout << "not equal test passed" << endl;
	}
	else
	{
		cout << "not equal test failed" << endl;
	}
	
	if (!(operatortest1 == operatortest2))
	{
		cout << "equal test passed" << endl;
	}
	else
	{
		cout << "equal test failed" << endl;
	}
	
	if (!(operatortest1 >= operatortest2) && operatortest1 >= operatortest3)
	{
		cout << "greater than or equal to test passed" << endl;
	}
	else
	{
		cout << "greater than or equal to test failed" << endl;
	}
	
	cout << "\n";
	
	BigNum ostest1 = 56790;
	BigNum ostest2 = (string)"1234567890098765432112345678900987654321";
	
	cout << "num: " << ostest1 << endl;
	cout << "string: " << ostest2 << endl;
	...
	BigNum numone = 1206;
	BigNum numtwo = 7;
	BigNum numthree = (string)"766865555555555575692986736529723492823969690827637";
	BigNum sum;
	BigNum diff;
	BigNum pp;
	BigNum mm1 = numone;
	...
	cout << "plus plus: " << pp << endl;
	cout << "minus minus: " << mm << endl;
	cout << "plus equals 2: " << pe << endl;
	cout << "minus equals 2: " << me << endl;
	cout << "factorial: " << fact << endl;
	cout << div2 << " / " << div1 << " = " << div << endl;
	cout << rem1 << " % " << rem2 << " = " << rem << endl;
