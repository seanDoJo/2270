...
int main()
	{
		...
		cout << "ItemCount before self-assignment: " << aBag.getCurrentSize() << endl;
		aBag = aBag;
		cout << "ItemCount after self-assignment: " << aBag.getCurrentSize() << endl;
			
		ArrayBag<string> newBag;
		newBag = aBag;
		otherContents = newBag.toVector();
		cout << "contents of newBag" << endl;
